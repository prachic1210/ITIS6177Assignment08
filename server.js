...
* /say:
*  get:
*   description: Returns greeting from AWS lambda function
*   produces:
*      - application/json
*   parameters:
*    - name: keyword
*      in: query
*      description: Aws function should return this keyword as greeting
*      required: true
*      type: string
*   responses:
*      200:
...
app.get('/say', async function(req,res){
      ...
      let api_url = "https://v6rqn6jakd.execute-api.us-east-1.amazonaws.com/prod/say-greeting";
      res.header('Content-type','application/json');
      axios.get(api_url +"?keyword="+keyword)
      .then((response)=>{
            console.log("Aws function says"+response.data);
